/**
 * packages/providers/src/community/gemini/options-translator.ts — Gemini community provider.
 * Pure-function core: OPTION_MAPPING + translateOptions + translateChunk + warnIgnoredOptions.
 * Triage source of truth: Gemini SDK repo spec/archon/mapping.md (25 prefixed keys, buckets 7/5/4/9).
 */

import type { SendQueryOptions, MessageChunk as ArchonMessageChunk } from '../../types.js';
import type { QueryOptions, MessageChunk as SdkMessageChunk } from '@gemini-sdk/gemini';

// OPTION_MAPPING — 25 prefixed keys, bucketed 7/5/4/9 per mapping.md.
