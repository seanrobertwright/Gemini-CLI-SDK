...
- [x] **MCP-02**: SDK uses an isolated temp `GEMINI_CONFIG_DIR` per query — NEVER mutates user's real `~/.gemini/settings.json`
- [x] **MCP-03**: SDK gates which MCP servers gemini-cli can use via `--allowed-mcp-server-names`
